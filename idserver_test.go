...
func TestGenerateIdTokenAuthCodeGrant(t *testing.T) {
	var at = AuthToken{}
	qq := CodeCheck{}
	resp, code, err := _sut.GenerateIdTokenResponse(qq, "RS256", "test", at.Aud, ClientCredentialsGrant, "", "", "", "", at, *new(http.ResponseWriter), new(http.Request))
	if err != nil {
		log.Err(err)
	}
